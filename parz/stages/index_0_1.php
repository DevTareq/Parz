...
function getHeaders()
{
    ...
    $fp = fopen('_data/orders_0_1.iif', 'r');
...
function mergeHeadersValues($headers, $values)
{
    ...
    foreach ($nestedHeaders as $nestedHeader) {
        ...
        if (isset($nestedHeaders[$nestedCount])) {

            $mergedValues['nestedHeadersValues'][$nestedHeaders[$nestedCount]] = $values['nestedHeadersValues'][$nestedCount];
        }
